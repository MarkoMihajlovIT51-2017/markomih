...
public class Hexagon implements Serializable {
	...
	public Hexagon(int x, int y, int r) throws IllegalRadiusException {
		if(r>0) {
			this.x = x;
			this.y = y;
			setR(r);
	...
	public Hexagon(int x, int y, int r, Color outlineColor, Color fillColor) throws IllegalRadiusException {
		if(r>0) {
			this.x = x;
			this.y = y;
			setR(r);
